...
```bash
export KMS_PROJECT="acme-lz3-sec-core-0"
export KEYRING_US_CENTRAL1="kr-us-central1"
export LOCATION_US_CENTRAL1="us-central1"
export KEYRING_US_EAST4="kr-us-east4"
export LOCATION_US_EAST4="us-east4"
```
...
```bash
# Get project number:
export PROJECT_NUMBER_app_dev_0=$(gcloud projects describe acme-lz3-app-dev-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_app_int_0=$(gcloud projects describe acme-lz3-app-int-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_app_prd_0=$(gcloud projects describe acme-lz3-app-prd-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_app_stg_0=$(gcloud projects describe acme-lz3-app-stg-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_dp_dev_0=$(gcloud projects describe acme-lz3-dp-dev-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_dp_int_0=$(gcloud projects describe acme-lz3-dp-int-0 --format="value(projectNumber)")
...
gcloud kms keys add-iam-policy-binding dataflow \
  --keyring=kr-us-central1 --location=us-central1 --project=$KMS_PROJECT \
  --member="serviceAccount:service-$PROJECT_NUMBER_dp_int_0@dataflow-service-producer-prod.iam.gserviceaccount.com" \
  --role="roles/cloudkms.cryptoKeyEncrypterDecrypter"
...
```bash
# Get project number:
export PROJECT_NUMBER_dp_prd_0=$(gcloud projects describe acme-lz3-dp-prd-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_dp_stg_0=$(gcloud projects describe acme-lz3-dp-stg-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_gke_dev_0=$(gcloud projects describe acme-lz3-gke-dev-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_gke_int_0=$(gcloud projects describe acme-lz3-gke-int-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_gke_prd_0=$(gcloud projects describe acme-lz3-gke-prd-0 --format="value(projectNumber)")
...
```bash
# Get project number:
export PROJECT_NUMBER_gke_stg_0=$(gcloud projects describe acme-lz3-gke-stg-0 --format="value(projectNumber)")
