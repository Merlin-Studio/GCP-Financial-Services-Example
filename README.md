...
This is a reference configuration for a GCP Landing Zone foundation for US fintechs. SOC 2 + PCI-DSS + NIST 800-53 + SOX, generated by [Merlin Studio](https://app.merlin-studio.cloud) — a GCP Landing Zone Design Studio built on [Cloud Foundation Fabric (FAST)](https://github.com/GoogleCloudPlatform/cloud-foundation-fabric). Generate your own at [app.merlin-studio.cloud](https://app.merlin-studio.cloud).
